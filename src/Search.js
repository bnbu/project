...
class Search extends Component {
    ...
    render() {
        ...
        const prevpage = <Link to={'/board/search/' + this.state.search_type + '/' + this.state.keyword + '/' + (this.state.startpage - 10)}><button type='button' className='btn btn-outline-primary' onClick={this.handleClickPrev}>이전</button></Link>
        const nextpage = <Link to={'/board/search/' + this.state.search_type + '/' + this.state.keyword + '/' + (this.state.startpage + 10)}><button type='button' className='btn btn-outline-primary' onClick={this.handleClickNext}>다음</button></Link>
            ...
            <div className='border'>
                ...
                <div id='etc'>
                    <div id='search_box' class='input-group mb-4'>
                      ...
                      <Link to={'/board/search/' + this.state.search_type + '/' + this.state.keyword + '/1'}><div class='btn btn-outline-primary'>검색</div></Link>
                    </div>
                    <div id='edit_box'>
